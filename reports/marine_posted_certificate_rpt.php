...
<font face="monospace" size="10">
	...
	<table cellpadding="2" border="0">
		...
		<tr>
			<td></td>
			<td align="center"><b>MAAGAP INSURANCE INC.</b></td>
		</tr>
		<tr>
...
';
$pdf->Image("marine_posted_certificate_rpt/signa.jpg", 126, 245, 60, 0, "", "", "", true, 300);
$pdf->writeHTML($html, true, false, true, false, '');
/* end page 2 */
/* begin page 3 */
if ($result["mortgagee"] != "") {
	...
	<font face="monospace" size="10">
		...
		<table cellpadding="2" border="0">
			...
			<tr>
				<td></td>
				<td align="center"><font size="14"><b>EDWARD N. SUY</b></font></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td></td>
				<td align="center"><b>Technical Operations</b></td>
			</tr>
		</table>
	</font>
	';
	$pdf->Image("marine_posted_certificate_rpt/signa.jpg", 127, 225, 60, 0, "", "", "", true, 300);
	$pdf->writeHTML($html, true, false, true, false, '');
}
/* end page 3 */
